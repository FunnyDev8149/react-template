                ...
                <div className={ `product-single-details mb-1 ${ adClass }` }>
                    <div className="single-product-custom-block">
                        <div className="temp-block">
                            <h5 className="temp-heading d-inline-block">Free Shipping</h5>

                            <h5 className="temp-heading d-inline-block">100% Money Back Guarantee</h5>

                            <h5 className="temp-heading d-inline-block">Online Support 24/7</h5>
                        </div>
                    </div>
